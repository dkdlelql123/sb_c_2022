...
public interface MemberRepository {
	...
	void join(@Param("loginId") String loginId, @Param("loginPw") String loginPw, @Param("email") String email,
	...
	@Select("""
			...
			""")
	List<Member> getForPrintMembers(String searchKeywordType, String searchKeyword, int searchAuthLevel, int limitStart,
			int limitTake);
